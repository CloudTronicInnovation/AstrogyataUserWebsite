...
import NumerologyNo from "./NumerologyNo";
class Numerology extends React.Component {
  ...
  submitHandler = e => {
    ...
    console.log("shgdjhg", payload);
    axiosConfig
      .post(`/user/numerologyApi`, payload)
      .then(response => {
            ...
            <Row>
              <Col md="12">
                <Card className="mb-50 pt-d">
                  <h3>Numerology</h3>
                  <p>
                    Under numerology assigns symbolic meanings to numbers and
                    their combinations. It is based on the idea that each number
                    has a unique vibration that can influence a person's life,
                    personality, and destiny. Numerologists use a person's birth
                    date, name, or other numerical values associated with them
                    to calculate and interpret their life number and number of
                    destiny and other significant numbers. They then use this
                    information to provide insights into a person's character
                    traits, strengths, weaknesses, and potential life path.
                    Numerology is often used in conjunction with other
              ...
              <Col md="12">
                <Card className="mb-50 pt-d">
                  ...
                  <p>
                    <p>
                      Under numerology assigns symbolic meanings to numbers and
                      their combinations. It is based on the idea that each
                      number has a unique vibration that can influence a
                      person's life, personality, and destiny. Numerologists use
                      a person's birth date, name, or other numerical values
                      associated with them to calculate and interpret their life
                      number and number of destiny and other significant
                      numbers. They then use this information to provide
                      insights into a person's character traits, strengths,
                      weaknesses, and potential life path. Numerology is often
                      used in conjunction with other practices, such as
                      astrology and tarot.
                    </p>
                  </p>
