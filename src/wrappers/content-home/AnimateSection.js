...
import cloth from "../../assets/img/logo/cloth.png";

import "../../assets/scss/_animation.scss";

export class AnimateSection extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Container className="pt-5">
        {/* <div className="logo">
          <img src="http://i68.tinypic.com/iod6yh.png" alt="" />
        </div> */}
        ...
        >
          ...
          <div
            className="ball"
            style={{ WebkitTransform: `rotateY(${droidX / 2}deg)` }}
          >
            <img src={cloth} alt="" style={{ width: "350px" }} />
